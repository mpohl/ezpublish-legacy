...
<div class="pagenavigator grid min-resp no-gutters">
<p>
   <div class="previous unit one-third">
      {switch match=$:item_previous|lt(0) }
         {case match=0}
            <a class="button button-widget" href={concat($page_uri,$:item_previous|gt(0)|choose('',concat($:offset_text,$:item_previous)),$:view_parameter_text,$page_uri_suffix)|ezurl}><span class="text">&laquo;&nbsp;{"Previous"|i18n("design/standard/navigator")}</span></a>
         {/case}
         {case match=1}
            &nbsp;
         {/case}
   ...
   <div class="pages unit one-third" style="text-align: center;">
   ...
   <div class="next unit one-third">
    {switch match=$:item_next|lt($item_count)}
      {case match=1}
        <a class="button button-widget" href={concat($page_uri,$:offset_text,$:item_next,$:view_parameter_text,$page_uri_suffix)|ezurl}><span class="text">{"Next"|i18n("design/standard/navigator")}&nbsp;&raquo;</span></a>
      {/case}
      {case}
         &nbsp;
      {/case}
