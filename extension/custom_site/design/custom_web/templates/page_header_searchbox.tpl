...
<form id="searchformmobile" class="searchbox" method="get" action="{'/content/search'|ezurl( 'no' )}" >
    <input type="text" name="SearchText" class="field searchtext" placeholder="Suchen..." />
    {if eq( $ui_context, 'browse' )}
        <input name="Mode" type="hidden" value="browse" />
    {/if}
