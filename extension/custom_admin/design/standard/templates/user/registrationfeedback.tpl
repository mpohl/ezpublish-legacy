...
Sie können den Benutzer nun aktivieren und ihn dann aus der Benutzergruppe 'Benutzer' in die entsprechende Benutzergruppe verschieben.

Link zum Aktivieren des Benutzers:
http://{$site_url}/user/unactivated
